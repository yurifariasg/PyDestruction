...
class BuildExe:
    def __init__(self):
        ...
        #Name of program
        self.project_name = "PyDestruction"
        ...
        self.license = "Yuri License"
 
        #Auhor of program
        self.author_name = "Yuri Farias Gomes"
        self.author_email = "yurifariasg@gmail.com"
        self.copyright = "Copyright (c) 2012 Yuri."
 
        #Description
        self.project_description = "PyDestruction Game"
 
        #Icon file (None will use pygame default icon)
        self.icon_file = None
 
        #Extra files/dirs copied to game
        self.extra_datas = ['screens', 'powerups', 'imagens', 'cenario']
        ...
        self.extra_scripts = [
            'Block.py', 'Bomb.py', 'Bomberman.py', 'Enemy.py',
            'Fire.py', 'Map.py', 'PathNode.py', 'Physics.py',
            'Player.py', 'PowerUP.py', 'Settings.py']
